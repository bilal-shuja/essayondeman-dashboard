...
const UpdateAssignmentType = () => {
    ...
    const submitServices = ()=>{
        ...
        axios.post(`${process.env.REACT_APP_BASE_URL}assignmenttype/updateassignmenttype`,serviceObj,{
        headers:{
          Authorization:token
        }
      ...
      <div className="content-header-left col-md-9 col-12 mb-2">
        <div className="row breadcrumbs-top">
          <div className="col-12">
            <h2 className="content-header-title float-start mb-0">Update Assignment Type</h2>
          ...
          <div className="col-md-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">Update Assignment Type</h4>
              </div>
              <div className="card-body">
                <div className="row">

                  <div className="col-xl-4 col-md-6 col-sm-12 mb-2">
                    <label className="form-label" htmlFor="credit-card"> <b> Assignment Type*</b></label>
...
export default UpdateAssignmentType