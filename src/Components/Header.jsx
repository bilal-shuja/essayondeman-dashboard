  ...
  <nav className="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow container-xxl">
    <div className="navbar-container d-flex content">
      ...
      <ul className="nav navbar-nav align-items-center ms-auto">
        ...
        <li className="nav-item dropdown dropdown-notification me-25"><a className="nav-link" href="#" data-bs-toggle="dropdown" ><i className="ficon" data-feather="bell"  /> <img className="img-fluid"src={Notifi} alt="" style={{marginTop:"-1.7em", marginLeft:"-0.9em"}} /></a>
          <ul className="dropdown-menu dropdown-menu-media dropdown-menu-end">
            {/* <li className="dropdown-menu-header">
              <div className="dropdown-header d-flex">
        ...
        <li className="nav-item dropdown dropdown-user"><a className="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div className="user-nav d-sm-flex d-none"><span className="user-name fw-bolder">{userName}</span><span className="user-status">Admin</span></div><span className="avatar"><img className="round" src={Avatar} alt="avatar" height={40} width={40} /><span className="avatar-status-online" /></span>
          </a>
              ...
              <a className="dropdown-item" href="page-pricing.html">
                ...
                <a className="dropdown-item" href="page-faq.html">
                  ...
                  <a href="/" className="dropdown-item" onClick={LogOut}>
                    <i className="me-50" data-feather="power" /> Logout</a>
          </div>
        </li>
      </ul>
    </div>
