  ...
  <div className="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div className="navbar-header">
      <ul className="nav navbar-nav flex-row">
        <li className="nav-item me-auto"><a className="navbar-brand" href="/"><span className="brand-logo">
              <svg viewBox="0 0 139 95" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" height={19}>
                <defs>
            ...
            <h2 className="brand-text" style={{fontSize:"17px", marginLeft:"-0.5em"}}>EssayonDemand</h2>
          </a>
          </li>
    ...
    <div className="main-menu-content">
      <ul className="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li className="nav-item"><Link className="d-flex align-items-center" to="/"><i data-feather="user" /><span className="menu-title text-truncate" data-i18n="User">User Profile</span></Link>
        </li>
        <li className="nav-item"><Link className="d-flex align-items-center" to="/CreateOrder"><i data-feather="plus-circle" /><span className="menu-title text-truncate" data-i18n="clipboard">Place Order</span></Link>
        </li>
        <li className="nav-item"><Link className="d-flex align-items-center" to="/ExampleForm"><i data-feather="clipboard" /><span className="menu-title text-truncate" data-i18n="clipboard">Orders</span></Link>
        </li>
        <li className="nav-item"><Link className="d-flex align-items-center" to="/WriterScreen"><i data-feather="users" /><span className="menu-title text-truncate" data-i18n="users">Writers</span></Link>
        </li>
        <li className="nav-item"><a className="d-flex align-items-center" href="app-kanban.html"><i data-feather="feather" /><span className="menu-title text-truncate" data-i18n="feather">Services</span></a>
        </li>
        <li className="nav-item"><a className="d-flex align-items-center" href="#anything"><i data-feather="bar-chart-2" /><span className="menu-title text-truncate" data-i18n="Invoice">Statistics</span></a>
          {/* <ul className="menu-content">
        ...
        <li className=" nav-item"><Link className="d-flex align-items-center" to="/ControlContent"><i data-feather="file-text" /><span className="menu-title text-truncate" data-i18n="File Manager">Control Content</span></Link>
        </li>
        <li className=" nav-item"><a className="d-flex align-items-center" href="#"><i data-feather="thumbs-up" /><span className="menu-title text-truncate" data-i18n="thumbs-up">Feedback</span></a>
          {/* <ul className="menu-content">
        ...
        {/* <li className=" nav-item"><a className="d-flex align-items-center" ><i data-feather="power" /><span className="menu-title text-truncate" data-i18n="File Manager" onClick={LogOut}>Log out</span></a>
        </li>
         */}
