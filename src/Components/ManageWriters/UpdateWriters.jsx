                ...
                <div className="breadcrumb-wrapper">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item">
                        <Link to="/WritersTable">Back</Link>
                    </li>
                  ...
                  <div className="card-body">
                    <div className="row">
                      ...
                      <div className="col-xl-4 col-md-6 col-sm-12 mb-2">
                        ...
                        <input type="text" className="form-control credit-card-mask" name="writerName"  onChange={inputHandler} placeholder="Enter Writers Name" id="credit-card" maxLength={16} required />
                      </div>
