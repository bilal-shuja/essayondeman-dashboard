    ...
    const[token , setToken] = useState()
      ...
      const [writerContent, setWriterContent] = useState({
        ...
        const submitWriterContent = ()=>{
          ...
          .then(res =>{
              toast.info("Writers Content Updated!")
            setInterval(() => {
      ...
      <div className="content-header-left col-md-9 col-12 mb-2">
        <div className="row breadcrumbs-top">
          <div className="col-12">
            <h2 className="content-header-title float-start mb-0">Update Writers Content</h2>
          ...
          <div className="col-md-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">UpdateWriter Content </h4>
              </div>
...
export default UpdateWritersContent